...
import cmn.framework.spring.PropertiesUtil;
...
public class JwtUtil {
	...
	public static void main(String args[]) throws Exception {
		String jwt = generateJwt("kimdoy", "cmn", "STIS_PRJ", 100000);
		System.out.println("jwt ::" + jwt);
		validateJwt(jwt, "kimdoy", "cmn", "STIS_PRJ");
	}
