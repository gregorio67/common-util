...
public class CamelUtil {
     ...
     * 
     *<pre>
     * Convert key of map to camel case 
     *</pre>
     * @param sourceMap Map<String, Object>
     * @return Map<String, Object> 
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
	public static Map<String, Object> convert2CamelCase(Map<String, Object> sourceMap)  throws Exception {
    	
    	Map<String, Object> resultMap = new LinkedHashMap<String, Object>();
    	
    	Iterator<String> itr = sourceMap.keySet().iterator();
    	while(itr.hasNext()) {
    		String key = itr.next();
    		
    		/** If instance is Map, recursive call **/
    		if ( sourceMap.get(key) instanceof Map) {
    			
    			resultMap.put(convert2CamelCase(key), convert2CamelCase((Map<String, Object>)sourceMap.get(key)));
    		}
    		else {
    			resultMap.put(convert2CamelCase(key), sourceMap.get(key));
    		}
    	}
