...
//			marshaller.setProperty(Marshaller.JAXB_FRAGMENT, Boolean.TRUE);
			...
			throw new UtilException("XML to Sting conversion error", e);
		}
		return xmlDoc;
	}
...
//			marshaller.setProperty(Marshaller.JAXB_FRAGMENT, Boolean.TRUE);
			...
			LOGGER.error(e.getMessage());
			throw new BaseException("XML to File conversion error", e);
		}
	}
	...
	public static <T> T xmlString2Object(Class<T> clazz, String xmlDoc) throws Exception {
		...
		try {
			...
			LOGGER.error(e.getMessage());
			throw new BaseException("XML String to Object conversion error", e);
		}
	}
	...
	public static <T> T xmlFile2Object(Class<T> clazz, String fileName) throws Exception {
		...
		try {
			...
			LOGGER.error(e.getMessage());
			throw new BaseException("XML File to Object conversion error", e);
		}
	}
